...
if [[ -f ".env" ]] && [[ -f "my_account.session" ]]; then
  echo "It seems that W1l1z-Userbot is already installed. Exiting..."
  exit
fi
...
EOL
  ...
  *)
    echo
    echo "============================"
    echo "Great! W1l1z-Userbot installed successfully!"
